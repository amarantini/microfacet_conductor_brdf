...
class BSDF {
 public:
   ...
   */
  virtual Spectrum eval (const Vector3D& wo, const Vector3D& wi) = 0;
   ...
   */
  virtual Spectrum sample (const Vector3D& wo, Vector3D* wi, float* pdf) = 0;
...
class DiffuseBSDF : public BSDF {
 public:
  ...
  Spectrum eval(const Vector3D& wo, const Vector3D& wi);
  Spectrum sample(const Vector3D& wo, Vector3D* wi, float* pdf);
